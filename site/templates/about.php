...
<article class="cf about">
    ...
    <!-- <h4>GET IN TOUCH</h4>
    <ul class="contacts">
    	<li><a href="mailto:matejlatin@gmail.com?subject=Hello Matej"><svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
     width="28px" height="28px" viewBox="0 0 21.5 14" style="enable-background:new 0 0 21.5 14;" xml:space="preserve">
<path style="fill-rule:evenodd;clip-rule:evenodd;" d="M15.058,6.902L21.5,0.347v13.109L15.058,6.902z M10.042,9.323L0.878,0h19.747
